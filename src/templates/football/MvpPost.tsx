...
export const footballMvpPostSchema = MvpGraphicSchema;
export type FootballMvpPostProps = z.infer<typeof footballMvpPostSchema>;

export function FootballMvpPost(props: FootballMvpPostProps) {
  const {
    kolejka,
    kategoria_wiekowa,
    faza_rozgrywek,
