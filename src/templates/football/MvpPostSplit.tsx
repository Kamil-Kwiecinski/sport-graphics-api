...
export const footballMvpPostSplitSchema = MvpGraphicPhotoSchema;
export type FootballMvpPostSplitProps = z.infer<
  typeof footballMvpPostSplitSchema
>;
 ...
 */
export function FootballMvpPostSplit(props: FootballMvpPostSplitProps) {
  const {
    kolejka,
    kategoria_wiekowa,
    faza_rozgrywek,
