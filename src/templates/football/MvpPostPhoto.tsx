...
export const footballMvpPostPhotoSchema = MvpGraphicPhotoSchema;
export type FootballMvpPostPhotoProps = z.infer<
  typeof footballMvpPostPhotoSchema
>;
 ...
 */
export function FootballMvpPostPhoto(props: FootballMvpPostPhotoProps) {
  const {
    kolejka,
    kategoria_wiekowa,
    faza_rozgrywek,
