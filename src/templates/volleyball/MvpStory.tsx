...
export const volleyballMvpStorySchema = MvpGraphicSchema;
export type VolleyballMvpStoryProps = z.infer<typeof volleyballMvpStorySchema>;

export function VolleyballMvpStory(props: VolleyballMvpStoryProps) {
  const {
    kolejka,
    kategoria_wiekowa,
    faza_rozgrywek,
