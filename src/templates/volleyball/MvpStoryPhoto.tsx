...
export const volleyballMvpStoryPhotoSchema = MvpGraphicPhotoSchema;
export type VolleyballMvpStoryPhotoProps = z.infer<
  typeof volleyballMvpStoryPhotoSchema
>;

export function VolleyballMvpStoryPhoto(props: VolleyballMvpStoryPhotoProps) {
  const {
    kolejka,
    kategoria_wiekowa,
    faza_rozgrywek,
