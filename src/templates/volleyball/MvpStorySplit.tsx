...
export const volleyballMvpStorySplitSchema = MvpGraphicPhotoSchema;
export type VolleyballMvpStorySplitProps = z.infer<
  typeof volleyballMvpStorySplitSchema
>;
 ...
 */
export function VolleyballMvpStorySplit(props: VolleyballMvpStorySplitProps) {
  const {
    kolejka,
    kategoria_wiekowa,
    faza_rozgrywek,
